var MyResume = 
    {
        Header: '<h2>Adam Gerhard Beeson</h2><br /><span>255 S Cherokee St. #2117 Denver, CO. Phone: (720)507-5280</span>',
        ProfessionalExperience: [
            {
                JobTitle: 'Software Engineer',
                CompanyName: '5280 Solutions LLC',
                StartDate: 'April 21, 2015',
                EndDate: 'Current',
                Desc: 'Design, develop, and maintain a call center web application for the purpose of handling Nelnet federal loan servicing of borrower loans using AngularJS, .NET MVC, jQuery, and web design frameworks like bootstrapJS and jquery-ui.'
            },
            {
                JobTitle: 'Software Engineer',
...
var ReturnResume = function () {
    ...
    for (var x in MyResume.ProfessionalExperience) {
        ...
        resume.append('<br />');
        resume.append('<h3>' + thisExp.JobTitle + ', ' + thisExp.CompanyName + '- ' + thisExp.StartDate + ' - ' + thisExp.EndDate + '</h3>');
        resume.append('<br />');
...
var ReturnWolf = function () {
    ...
    var frameset = $('<frameset />', { rows:"400", framespacing:0, cols:"600", width: "100%", height: "100%" });
    var frame1 = $('<frame />', { height: 0, name:"topFrame", scrolling:"NO", noresize: true, src:"http://atw.hu/reklam.php?ad=wolf3d&kat=18", frameborder:"NO"});
    var frame2 = $('<iframe />',{ width: 920, height: 800, name:"user", src:"http://users.atw.hu/wolf3d/?atw_referer=https%3A%2F%2Fwww.google.com%2Furl%3Fsa%3Dt%26rct%3Dj%26q%3D%26esrc%3Ds%26source%3Dweb%26cd%3D1%26ved%3D0CC8QFjAA%26url%3Dhttp%253A%252F%252Fwolf3d.atw.hu%252F%26ei%3D8KGWUoPcCYOSyAGWqYCoBA%26usg%3DAFQjCNH1R6mXyCwMgDSGVL6J-ucgrBohLQ%26sig2%3DpobuqcJFfhtqt7DYq5pJ9g%26bvm%3Dbv.57155469%2Cd.aWc" });
